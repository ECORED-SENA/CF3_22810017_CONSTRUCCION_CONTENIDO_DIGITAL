...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5
      img.img-p-t1(src='@/assets/curso/temas/imagen-tema1.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.mb-5
      .col-lg-10.cajon.fondo-color-sistema-j(data-aos="fade-down")
        .row.justify-content-center.align-items-center
          .col-lg-2.col-4.p-lg-1.p-1
            figure
              img(src='@/assets/curso/temas/brand-awareness.svg', alt='Icono de una bocina')
          .col-lg-8.p-lg-4.px-4
            p Se debe recordar que para crear una imagen se debe tener en cuenta lo siguiente:
            ul.lista.lista-person-1.lista-ul--color.p-1.mb-0
              li 
                i.fas.fa-check
    ...
    .bloque-texto-a.fondo-color-sistema-k.p-4.p-md-5.mb-5(data-aos="fade-down")
    ...
    PasosA.color-acento-contenido.mb-5(tipo="n")(data-aos="fade-down")
      .row.align-items-center
        .col-md-3.px-lg-5.p-5
          figure
            img(src='@/assets/curso/temas/icono-paso1.svg', alt='Icono de alistamiento')
        .col-md-9
      ...
      .row.align-items-center
        ...
        .col-md-3.px-lg-5.p-5
          figure
            img(src='@/assets/curso/temas/icono-paso2.svg', alt='Icono de calendario')

      .row.align-items-center
        .col-md-3.px-lg-5.p-5
          figure
            img(src='@/assets/curso/temas/icono-paso3.svg', alt='Icono de boceto')
        .col-md-9
      ...
      .row.align-items-center
        ...
        .col-md-3.px-lg-5.p-5
          figure
            img(src='@/assets/curso/temas/icono-paso4.svg', alt='Icono de diseño')

      .row.align-items-center
        .col-md-3.px-lg-5.p-5
          figure
            img(src='@/assets/curso/temas/icono-paso5.svg', alt='Icono de imagenes')
        .col-md-9
